...
# Requires VPN connection: certs.corp.redhat.com is internal to Red Hat
RUN curl --fail -Lo /tmp/2022-IT-Root-CA.pem https://certs.corp.redhat.com/certs/2022-IT-Root-CA.pem \
